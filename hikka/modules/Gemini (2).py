...
class Gemini(loader.Module):
    ...
    strings = {
        ...
        "asking_gemini": "<emoji document_id=5438268597849827727>❤️</emoji> <b> ищу сучка </b>",
    }
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            ...
            loader.ConfigValue(
                "text",
                """<emoji document_id=5240027055088745962>🌟</emoji> <b>иди нахуй</b> {question}

<emoji document_id=5240027055088745962>🌟</emoji> <b>Ответ:</b> {answer}""",    
                lambda: "Текст вывода",
            ),
        )
